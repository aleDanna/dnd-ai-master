...
const BEGIN_INSTRUCTION: Record<string, string> = {
  en: '[Begin the campaign now. Open the scene by narrating, in second person, the player character\'s immediate surroundings and the situation that draws them in — strictly grounded in the Campaign premise above. Voice any NPCs in earshot. Do NOT call any state-mutating tool (no add_item, award_xp, apply_damage, roll_initiative, etc.) on this opening turn — just establish the scene. Do NOT start combat, do NOT have any creature attack the player, and do NOT ask for any dice roll on this opening turn: present any threat as something the player can choose to approach, avoid, or react to — let THEM decide whether to fight. End with an open-ended cue inviting the player\'s first action.]',
  it: '[Inizia la campagna ora. Apri la scena narrando, in seconda persona, ciò che il personaggio giocante percepisce nell\'ambiente circostante e la situazione che lo coinvolge — strettamente ancorato alla Premessa della campagna sopra. Dai voce a qualunque PNG a portata d\'orecchio. NON chiamare alcun tool che muta lo stato (niente add_item, award_xp, apply_damage, roll_initiative, ecc.) in questo turno di apertura — limitati a stabilire la scena. NON iniziare un combattimento, NON far attaccare alcuna creatura e NON chiedere alcun tiro di dado in questo turno di apertura: presenta eventuali minacce come qualcosa che il giocatore può scegliere se affrontare, evitare o a cui reagire — sia LUI a decidere se combattere. Concludi con uno spunto aperto che inviti la prima azione del giocatore.]',
  es: '[Comienza la campaña ahora. Abre la escena narrando, en segunda persona, lo que el personaje jugador percibe a su alrededor y la situación que lo involucra — estrictamente anclado a la Premisa de la campaña arriba. Da voz a cualquier PNJ al alcance. NO llames a ninguna herramienta que mute el estado en este turno de apertura — solo establece la escena. NO inicies un combate, NO hagas que ninguna criatura ataque al jugador y NO pidas ninguna tirada de dados en este turno de apertura: presenta cualquier amenaza como algo que el jugador puede elegir afrontar, evitar o a lo que reaccionar — que decida ÉL si pelear. Termina con un cierre abierto que invite a la primera acción del jugador.]',
  fr: '[Commence la campagne maintenant. Ouvre la scène en narrant, à la deuxième personne, ce que le personnage perçoit autour de lui et la situation qui le concerne — strictement ancrée dans la Prémisse de la campagne ci-dessus. Donne voix aux PNJ à portée. N\'appelle AUCUN outil qui mute l\'état pendant ce tour d\'ouverture — établis simplement la scène. NE commence PAS de combat, NE fais PAS attaquer la moindre créature et NE demande AUCUN jet de dés pendant ce tour d\'ouverture : présente toute menace comme quelque chose que le joueur peut choisir d\'affronter, d\'éviter ou auquel réagir — que ce soit LUI qui décide de se battre. Termine par une invite ouverte appelant la première action du joueur.]',
  de: '[Beginne die Kampagne jetzt. Eröffne die Szene, indem du in der zweiten Person erzählst, was die Spielfigur in der unmittelbaren Umgebung wahrnimmt und welche Situation sie hineinzieht — streng verankert in der obenstehenden Kampagnen-Prämisse. Verleihe etwaigen NSCs in Hörweite eine Stimme. Rufe in dieser Eröffnungsrunde KEIN zustandsänderndes Werkzeug auf — etabliere nur die Szene. Beginne KEINEN Kampf, lass KEINE Kreatur die Spielfigur angreifen und fordere in dieser Eröffnungsrunde KEINEN Würfelwurf — stelle jede Bedrohung als etwas dar, dem sich die Spielfigur nähern, das sie meiden oder worauf sie reagieren kann; SIE entscheidet, ob gekämpft wird. Schließe mit einem offenen Hinweis, der die erste Aktion der Spielerin einlädt.]',
  pt: '[Comece a campanha agora. Abra a cena narrando, na segunda pessoa, o que o personagem percebe no entorno imediato e a situação que o envolve — estritamente ancorada na Premissa da campanha acima. Dê voz a quaisquer NPCs ao alcance. NÃO chame nenhuma ferramenta que mute o estado neste turno de abertura — apenas estabeleça a cena. NÃO inicie combate, NÃO faça nenhuma criatura atacar o jogador e NÃO peça nenhuma rolagem de dados neste turno de abertura: apresente qualquer ameaça como algo que o jogador pode escolher enfrentar, evitar ou a que reagir — que ELE decida se vai lutar. Termine com um gancho aberto convidando a primeira ação do jogador.]',
};
