...
describe('D-16 — server-resolved monster-turn suppression (monsterResolved)', () => {
  ...
  it('regression: monsterResolved ABSENT → byte-identical to current Phase-08 output (general/catalog path)', () => {
    ...
    const PHASE_08_GENERAL = [
      ...
      // Phase 08-02: numbered-name reminder (updated constant to match new output)
      'IMPORTANTE: usa sempre il NOME ESATTO dal tracker (combat.md), numero incluso.',
      'Esempio: "Tira 1d20+4 per attaccare Pirata di Buggy 2." — non "il pirata" o solo "Pirata di Buggy".',
