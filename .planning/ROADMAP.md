...
- [x] 09-02-PLAN.md — CR->stats table + named-constant defaults + pure `resolveMonsterTurn` (v1 hit rule, injected RNG, random live-PC target) (D-05, D-06, D-09, D-10, D-11)
